...
##############################################+=============================================================
root = tk.Tk()
root.configure(background="#73dcff")
    ...
    with sqlite3.connect('evaluation.db') as db:
        ...
        # Find user If there is any take proper action
         ...
         if result:
            ...
            from subprocess import call
            call(['python','house_predictor.py'])
...
# bg_icon=ImageTk.PhotoImage(file="E:/Project/100%house price prediction/L.jpg")
# bg_icon=ImageTk.PhotoImage(file="C:/Users\Nageshwari/Downloads/100%house price prediction/100%house price prediction/L.jpg")
bg_icon=None
bg_icon = ImageTk.PhotoImage(file="C:/nageshwari/100%house price prediction/L.jpg")


# bg_icon = ImageTk.PhotoImage(file="E:\\Project\\100%%house price prediction\\L.jpg")
user_icon=ImageTk.PhotoImage(file="C:/nageshwari/100%house price prediction/l1.png")
pass_icon=ImageTk.PhotoImage(file="C:/nageshwari/100%house price prediction/p1.jpg")
...
title.place(x=220,y=70,width=250)
        
Login_frame=tk.Frame(root,bg="white")
Login_frame.place(x=80,y=180)
