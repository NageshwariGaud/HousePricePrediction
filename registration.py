...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#0e0d84", fg="white")
l1.place(x=190, y=50)
...
btn = tk.Button(window, text="Register", bg="#0e0d84",font=('Times',17),fg="white", width=9, height=1, command=insert)
